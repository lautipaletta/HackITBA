...
class Raiser {
  ...
  Raiser({required this.name, required this.description, required this.contactInfo, required this.profileImageUrl}) : id = DateTime.now().millisecondsSinceEpoch.toString();
